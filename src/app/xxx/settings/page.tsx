...
const UserSettingsPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.namaLengkap || !formData.email) {
      showError('Mohon lengkapi Nama Lengkap dan Email');
      return;
    }
    ...
    try {
      ...
      console.warn('Error update profil:', error);
    ...
    <DashboardAdminLayout path="xxx">
      ...
      <div className="flex flex-col gap-4 sm:gap-6 px-2 sm:px-4 md:px-6 lg:px-8 pb-6">
        ...
        <div className="mt-3 bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden p-4 sm:p-6">
          <h2 className="text-lg font-semibold text-gray-800 mb-1">Pengaturan Profil Admin</h2>
          <p className="text-sm text-gray-500 mb-6">
            Atur informasi akun dan keamanan Anda.
          </p>
